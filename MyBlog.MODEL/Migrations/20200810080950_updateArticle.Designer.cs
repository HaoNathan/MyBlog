...
namespace MyBlog.MODEL.Migrations
{
    ...
    [Migration("20200810080950_updateArticle")]
            ...
            modelBuilder.Entity("MyBlog.MODEL.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2020, 8, 10, 16, 9, 49, 793, DateTimeKind.Local).AddTicks(3773),
                            IsRemove = false,
                            Name = "stackOverflow",
                            Password = "throwNewException",
                            UpdateTime = new DateTime(2020, 8, 10, 16, 9, 49, 793, DateTimeKind.Local).AddTicks(3257)
                        });
                });
