...
namespace MyBlog.MODEL.Migrations
{
    ...
    [Migration("20200808082328_updateTable")]
            ...
            modelBuilder.Entity("MyBlog.MODEL.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2020, 8, 8, 16, 23, 28, 629, DateTimeKind.Local).AddTicks(5538),
                            IsRemove = false,
                            Name = "stackOverflow",
                            Password = "throwNewException",
                            UpdateTime = new DateTime(2020, 8, 8, 16, 23, 28, 628, DateTimeKind.Local).AddTicks(5555)
                        });
                });
