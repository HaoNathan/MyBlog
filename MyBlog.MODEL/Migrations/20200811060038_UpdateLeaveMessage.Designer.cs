...
namespace MyBlog.MODEL.Migrations
{
    ...
    [Migration("20200811060038_UpdateLeaveMessage")]
    partial class UpdateLeaveMessage
    {
            ...
            modelBuilder.Entity("MyBlog.MODEL.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2020, 8, 11, 14, 0, 38, 14, DateTimeKind.Local).AddTicks(2271),
                            IsRemove = false,
                            Name = "stackOverflow",
                            Password = "throwNewException",
                            UpdateTime = new DateTime(2020, 8, 11, 14, 0, 38, 14, DateTimeKind.Local).AddTicks(1567)
                        });
                });
